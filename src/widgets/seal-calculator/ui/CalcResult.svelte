...
<div
	class={cn(
		...
		'left-[calc(var(--side-menu-w)+var(--content-side))]',
		'bottom-[calc(var(--header-h)+var(--content-side))] land:bottom-[4vh]',
		'w-[calc(100%-var(--side-menu-w)-var(--side-ad-w)-var(--content-side)*2)]'
	)}
>
	<section
		class={cn(
			'h-calc-result-h w-[calc(var(--content-w)-var(--content-side)*4)] overflow-hidden',
